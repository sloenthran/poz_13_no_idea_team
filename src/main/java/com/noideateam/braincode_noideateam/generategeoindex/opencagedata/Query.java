...
public class Query {
    public ReturnGenerateGeoIndex ask(String localization) {
        ...
        return new ReturnGenerateGeoIndex(response.getResults().get(0).getGeometry().getLat(), response.getResults().get(0).getGeometry().getLng());
    }
}
